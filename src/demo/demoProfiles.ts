...
export const demoProfiles: Record<string, DemoProfile> = {
  'young-professional': {
    ...
    name: 'Alex Chen',
    avatar: '👨‍💻',
    description: 'Software engineer, 28, focused on wealth building and saving for a home',
    profile: {
  ...
  'family-focused': {
    ...
    name: 'Sarah Johnson',
    avatar: '👩‍👧‍👦',
    description: 'Marketing director, 38, balancing college savings and retirement',
    profile: {
  ...
  'near-retirement': {
    ...
    avatar: '👨‍🦳',
    description: 'Senior consultant, 58, preparing for retirement in 5-7 years',
    profile: {
